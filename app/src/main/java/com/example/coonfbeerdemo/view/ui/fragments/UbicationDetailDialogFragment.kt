...
class UbicationDetailDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        toolbarUbication.navigationIcon = ContextCompat.getDrawable(view.context, R.drawable.ic_close_white)
        ...
        tvUbicacionDireccion.text = ubication.adress
        tvUbicacionTelefono.text = ubication.phone
        ...
        llWebSiteLugar.setOnClickListener {
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse(ubication.website))
            startActivity(intent)
        }
    }
